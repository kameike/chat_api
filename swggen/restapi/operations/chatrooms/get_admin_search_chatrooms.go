...
type GetAdminSearchChatroomsHandlerFunc func(GetAdminSearchChatroomsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAdminSearchChatroomsHandlerFunc) Handle(params GetAdminSearchChatroomsParams) middleware.Responder {
	return fn(params)
}
...
type GetAdminSearchChatroomsHandler interface {
	Handle(GetAdminSearchChatroomsParams) middleware.Responder
}
