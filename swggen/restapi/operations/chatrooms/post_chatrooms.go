...
type PostChatroomsHandlerFunc func(PostChatroomsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PostChatroomsHandlerFunc) Handle(params PostChatroomsParams) middleware.Responder {
	return fn(params)
}

// PostChatroomsHandler interface for that can handle valid post chatrooms params
type PostChatroomsHandler interface {
	Handle(PostChatroomsParams) middleware.Responder
}
